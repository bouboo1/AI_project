...
data_path = r'./mnist_data/train-images.idx3-ubyte'
data_size = 47040016
data_size = str(data_size - 16) +'B'
data_buf = open(data_path, 'rb').read()

magic, numImages, numRows, numColumns = struct.unpack_from(
    '>IIII', data_buf, 0)
datas = struct.unpack_from(
    '>' + data_size, data_buf, struct.calcsize('>IIII'))
...
data_path = r'./mnist_data/t10k-images.idx3-ubyte'
